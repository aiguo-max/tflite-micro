...
#include "tensorflow/lite/micro/examples/accnet_hybrid_test/accnet_skip_stage0_conv_model_data.h"
#include "tensorflow/lite/micro/examples/accnet_hybrid_test/accnet_skip_stage0_conv_test_data.h"
#include "tensorflow/lite/micro/examples/accnet_hybrid_test/accnet_skip_s0_conv1_model_data.h"
#include "tensorflow/lite/micro/examples/accnet_hybrid_test/accnet_skip_s0_conv1_test_data.h"
...
int main(int argc, char* argv[]) {
  ...
  int ret = 0;
  ret += run_one(arena, "Test1: accnet_skip_stage0_conv (hybrid, float32 I/O)",
      ...
      g_accnet_skip_stage0_conv_ref_output_size, /*tol=*/0.05f);
  ret += run_one(arena, "Test2: accnet_skip_s0_conv1 (hybrid, float32 I/O)",
      ...
      g_accnet_skip_s0_conv1_ref_output_size, /*tol=*/0.05f);
